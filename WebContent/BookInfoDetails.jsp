    ...
    <div class="login_wrapper">
     ...
     -->                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="Id" name="carid" value="<%=request.getAttribute("myid")%>" required="required">
                                </div>
                                <div class="form-group">
                                    <span><i class="fa fa-user"></i></span>      
                                ...
                                <div class="form-group">
                                    <span><i class="fa fa-user"></i></span>      
                                    <input type="text" class="form-control" placeholder="Driving Licence Number" name="drivinglicensenumber" required="required">
                                </div>
