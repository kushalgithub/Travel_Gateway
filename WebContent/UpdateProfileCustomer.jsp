                ...
                <div class="col-md-offset-3 col-md-6 col-md-offset-15" style="margin-top:170px; margin-bottom:300px">
                    <div class="login-widget animte-reavel">
                        ...
                        <div class="login-box" style="margin-bottom: 50px">
                            	<form action="UpdateController" method="post" name="form1">
                                ...
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" value="<%=request.getAttribute("c1")%>" placeholder="Customer Username" name="a" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="First Name" value="<%=request.getAttribute("c3")%>" name="c" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="Last Name" name="d" value="<%=request.getAttribute("c4")%>" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="Email" name="f" value="<%=request.getAttribute("c5")%>" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-group"></i></span> 
                                   <input type="text" class="form-control" placeholder="Password" name="g" value="<%=request.getAttribute("c7")%>" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="Contact Number" value="<%=request.getAttribute("c8")%>" name="i" required="required">
                                </div>
                               ...
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="City" value="<%=request.getAttribute("c9")%>" name="j" required="required">
                                </div>
                                
                                <div class="form-group">
                                  <span><i class="fa fa-user"></i></span> 
                                   <input type="text" class="form-control" placeholder="State" value="<%=request.getAttribute("c10")%>" name="k" required="required">
                                </div>
                                
                                <div class="form-actions clearfix">
                                   
                                    <div class="submit-form text-center">
                                        <input type="submit" value="Update" class="btn submit-btn">
