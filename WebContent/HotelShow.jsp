    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
               ...
               <form action="HotelSelectionController">
                <div class="sort-section-v2 animate-reveal">
                    <div class="row no-margin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="details-text">
                                <h4><%out.println(arr2.get(f));%><br><small> <i class="fa fa-map-marker"></i><%out.println(arr7.get(f));%></small></h4>
                            </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="select-sec">
                                ...
                                <a href="BookHotelController?id=<%out.println(arr1.get(f));%>" target="_blank" class="btn btn_select-v2">SELECT</a>
                            </div>
                        </div>
                    </div>
                </div>
