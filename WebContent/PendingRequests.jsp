...
<input type="hidden" name="pageName" value="pendingRequests">
...
for(VendorRegistrationBean v : vendor_profile)
{
 %>
   	<tbody>
							...
							<td><button type="submit" class="btn btn-default"  name="approve" value="<%out.print(v.getVendorusername());%>">Approve</button>
							<button type="submit" class="btn btn-default" name="reject" value="<%out.print(v.getVendorusername());%>">Reject</button>
							</td>
							</tr>
						</tbody>
...
<div style="background: #E0E0E0;border: #3B5998 1px solid;border-bottom:none;padding:6px;color:#13a3f7;font-size:12px"><span>Vendor Profile</span></div>
...
<button class="btn btn-default"  onmousedown="hidePopup()"><b>OK</b></button>
</div>
</div>
</div>
